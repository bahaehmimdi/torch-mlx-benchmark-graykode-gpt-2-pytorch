...
**Statut : OK — 10/10 pass (LM forward+presents, tied embeddings, backward 28/28, AdamW)**

**torch-mlx** est une reimplémentation de l'API PyTorch basée sur le moteur **MLX
d'Apple Silicon**. L'architecture de **graykode/gpt-2-Pytorch** a été testée de manière **non modifiée**.
